...
<b><form action="/StudentResult/Office/result_office.jsp" method="post">
			...
			<table align="center">
			    ...
			    <tr>
					...
					<td><input type="text" name="student_id" placeholder="Enter Student ID" required="required" onkeypress="return isNumberKey(event)" /></td>
				</tr>
				<tr align="center">
					<td></td>
