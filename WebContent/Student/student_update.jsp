...
try {
	...
	ps.execute();
	pw.println("<h1><font color=red>Informations Updateded Successfullty</font></h1>");
	pw.println("<br><a href =/StudentResult/Student/home.jsp>Go HomePage</a>");
    }
} catch (Exception ex) {
	pw.println(ex);
}
